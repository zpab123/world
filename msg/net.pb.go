...
type HandshakeRes struct {
	Code                 string   `protobuf:"bytes,20190233,opt,name=code,proto3" json:"code,omitempty"`
	Acceptor             uint32   `protobuf:"varint,1,opt,name=acceptor,proto3" json:"acceptor,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *HandshakeRes) GetCode() string {
	if m != nil {
		return m.Code
	}
	return ""
...
func (m *HandshakeRes) GetAcceptor() uint32 {
	if m != nil {
		return m.Acceptor
	}
	return 0
...
var fileDescriptor_a5b10ce944527a32 = []byte{
	...
	0x04, 0xe7, 0x2b, 0x39, 0xa2, 0x18, 0x50, 0x2c, 0x24, 0xca, 0xc5, 0x92, 0x9c, 0x9f, 0x92, 0x8a,
	0x30, 0x01, 0xcc, 0xc5, 0x67, 0x44, 0x12, 0x1b, 0xd8, 0x3d, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff,
	0xff, 0xbb, 0xdb, 0x9e, 0xb2, 0x9c, 0x00, 0x00, 0x00,
}
